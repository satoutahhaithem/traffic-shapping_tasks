...
# Setup script for the receiver PC in the Dynamic Quality Testing system
...
echo "=========================================================="
echo "Receiver PC Setup for Dynamic Quality Testing System"
echo "=========================================================="
...
pip install numpy requests flask opencv-python
...
echo ""
echo "You can view the receiver status at:"
echo "  http://$IP_ADDRESS:8081/status"
echo ""
