...
1.  **Start the Video Sender:**
    ...
    ```bash
    python WebRTC_Streaming/direct_sender.py --ip 192.168.2.120
    ```
...
2.  **Start the All-in-One `tc` Test Script:**
    ...
    ```bash
    sudo python WebRTC_Streaming/measurement_scripts/tc_all_in_one_synced.py --sender-ip 192.168.2.169
    ```
